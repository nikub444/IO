...
excel_book = excel_app.books.open('Dane_S2_200_20.xlsx')
tasks = 100
tabulist1 = []
tabulist2 = []
tabuWait = []
...
def TabuSearch(iterations, wait):
    for x in range(iterations):
        globalMin = int(excel_book.sheets['Arkusz1'].range('AQ201').value)
        inTabu = False
        ...
        localMin = int(excel_book.sheets['Arkusz1'].range('AQ201').value)
